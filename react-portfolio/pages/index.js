        ...
        <section>
          <div className="text-center py-2">
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
              With my strong proficiency in JS, HTML, CSS, Solidity, Python, and
              SQL, I excel in data analysis, machine learning, deep learning,
              and artificial intelligence. I believe that data-driven
